...
int main() {
    ...
    float vertices[] = {-0.5f, -0.5f, -0.5f, 0.0f,  0.0f,  -1.0f, 0.5f,  -0.5f, -0.5f, 0.0f,  0.0f,  -1.0f,
                        ...
                        -0.5f, 0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  -0.5f, 0.5f,  -0.5f, 0.0f,  1.0f,  0.0f};
    ShaderHelper sha;
    sha.addShaderByPath("shader/vertex1_phong_light.glsl", VERTEX_SHADER);
    sha.addShaderByPath("shader/fragment4_phong_light.glsl", FRAGMENT_SHADER);
    sha.linkShader();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // lightPos = glm::vec3(1.2f, 1.0f * sin(timeValue), 2.0f * sin(timeValue));
